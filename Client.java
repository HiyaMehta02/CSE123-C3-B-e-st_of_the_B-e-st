saves the current collection into a PrintStreamimport java.util.*;
import java.io.*;
public class Client {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        while (!option.equalsIgnoreCase("quit")) {
            ...
            if (option.equalsIgnoreCase("add")) {
                collectionManager.add(TVShow.parse(console));
                ...
                System.out.println(collectionManager.contains(TVShow.parse(console)));
                ...
                System.out.println("What genre do you want to filter?");
                String ans = console.nextLine();
                List<TVShow> n = collectionManager.filter(ans.trim()); 
                for (TVShow item : n) {
